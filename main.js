...
const works = [
    {
        ...
        workTerm: `3週間`,
        workPoint: `スクラップブック風のデザインになっています。ホバーするとケージから出してほしくて震えたり等、愛犬らしさを意識して作りました。工夫した点は、GSAPで手書き風の文字をIllustratorで描いたり、脱出ゲームのような仕掛けを作り、色々触ってみないと愛犬を見つけられないようにした点です。骨、肉球、うみぼうずはどこだ？は手描きで、フィルムは手作りです。看板も自作で、フリー素材をクリッピングマスクしています。`,
