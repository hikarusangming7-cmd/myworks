...
const works = [
    ...
    },
    {
        ...
        workPoint: `photoshopでフリー素材の女性を漫画風に加工して、illustratorで女性を囲っている中央線と黄色のテープを作りました。普段は少し高価で手が届きにくい美容家電やヘアケア商品を扱うECサイトにおいて、「今日だけ驚きの価格で手に入る」という強烈なお得感と緊急性をユーザーに直感的に伝えることをコンセプトに設計しました。漫画の雰囲気に合わせて、あえてCLEARANCE SALEにレガシー感を出しています。`,
