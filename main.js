...
const works = [
    ...
    },
    {
        ...
        {
        workImage:`images/cafebanner.png`,
        workTitle: `カフェのアルバイト募集のバナー`,
        workSkill: `Canva`,
        workPoint: `求職者の心理に寄り添い、単なる条件羅列で終わらせないためのアクセントとして「まかないは美味しいと評判です♪」というスタッフのイラスト付き吹き出しを配置しました。
        お店の親しみやすさや働く楽しさを演出し、ターゲットが応募への一歩を踏み出しやすくなるように意識して制作しました。`,
