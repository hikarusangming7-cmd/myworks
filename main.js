...
const works = [
    ...
    },
    {
        ...
        workSkill: `HTML/CSS/JavaScript`,
        workTerm: `製作中`,
        workPoint: `ユーザーの選択によって、エンディングが変わるようになっています。バッドエンドに遷移する選択肢のある分岐点では”運命の分かれ道です。どちらを選びますか？”とポップアップが出るようにしました。シナリオはシーンデータとして配列で管理し、各シーンにそれぞれIDを付与しています。選択肢には遷移先のIDを持たせ、ユーザーの選択に応じて対応するシーンを表示するようにしました。画像はAI生成しており、選択肢によって異なる展開の画像が表示されます。`,
