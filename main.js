...
const works = [
    {
        ...
        workTerm: `3週間`,
        workPoint: `スクラップブック風のデザインになっています。ケージから出してほしくて震えさせたり等、愛犬らしさを意識して作りました。工夫した点は、GSAPで手書き風の文字をIllustratorで描いたり、ただのポートフォリオにならないように、楽しめる仕掛けを考えたところです。骨、肉球、うみぼうずはどこだ？は手描きです。看板は自作ですが、フリー素材をクリッピングマスクしています。`,
    ...
    },
    {
        ...
        workSkill: `Canva`,
        workPoint: `板チョコレートをパキッと割ったときの様子を表現しています。「Noir（黒）」を象徴するトリュフを、右側にシズル感のあるチョコレートソースを配置し、「静」と「動」の対比で目を引く構成にしています。`,
